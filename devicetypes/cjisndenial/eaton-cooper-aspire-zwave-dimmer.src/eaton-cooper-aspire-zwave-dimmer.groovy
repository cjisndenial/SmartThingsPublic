 ...
 */
metadata {
	definition (name: "Eaton Cooper Aspire Z-Wave Dimmer", namespace: "cjisndenial", author: "CJ Saretto", ocfDeviceType: "oic.d.light") {
...
def parse(String description) {
	log.debug "cj Parse: $description"
    def result = null
...
def zwaveEvent(physicalgraph.zwave.commands.switchmultilevelv1.SwitchMultilevelReport cmd) {
	log.debug "cj SwitchMultilevelReport: $cmd"
    dimmerEvents(cmd)
}

def zwaveEvent(physicalgraph.zwave.commands.switchmultilevelv1.SwitchMultilevelSet cmd) {
	log.debug "cj SwitchMultilevelSet: $cmd"
    dimmerEvents(cmd)
}

private dimmerEvents(physicalgraph.zwave.Command cmd) {
	log.debug "cj DimmerEvents: $cmd"
...
def zwaveEvent(physicalgraph.zwave.commands.configurationv1.ConfigurationReport cmd) {
	log.debug "cj ConfigurationReport: $cmd"
	def value = "when off"
...
def zwaveEvent(physicalgraph.zwave.commands.switchmultilevelv1.SwitchMultilevelStopLevelChange cmd) {
	log.debug "cj SwitchMultilevelStopLevelChange: $cmd"
    [createEvent(name:"switch", value:"on"), response(zwave.switchMultilevelV1.switchMultilevelGet().format())]
}

def zwaveEvent(physicalgraph.zwave.commands.crc16encapv1.Crc16Encap cmd) {
	log.debug "cj Crc16Encap: $cmd"
...
def zwaveEvent(physicalgraph.zwave.Command cmd) {
	log.debug "cj Command (ignored): $cmd"
