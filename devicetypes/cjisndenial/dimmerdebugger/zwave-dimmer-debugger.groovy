 ...
 */
metadata {
	definition (name: "Z-Wave Dimmer Debugger", namespace: "smartthings", author: "cjisndenial", ocfDeviceType: "oic.d.light", runLocally: true, minHubCoreVersion: '000.019.00012', executeCommandsLocally: true) {
